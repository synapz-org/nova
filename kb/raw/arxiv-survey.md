...
Items 1–69 are **implemented** (§YYYYYYYYYYYY added 2026-09-03: multi-start §MM SALSA from diversity-maximised cache seeds — after §VVVVVVVVVVVV selects the reliability-adjusted primary seed, up to 2 more seeds are added via max-min Tanimoto on `_mm_all_scored`; each seed runs its own §MM round sequence; Tanimoto ≤ 0.15 guard prevents duplicate-scaffold seeds. §XXXXXXXXXXXX added 2026-09-01: cache-adaptive UCB beta — scales exploration coefficient from 1.0 at RF threshold to 0.5 at 725+ pts so a mature surrogate exploits more and explores less, complementing §WWWWWWWWWWWW). §WWWWWWWWWWWW added 2026-08-30: cache-adaptive surrogate blend alpha — scales `augment_pool_with_surrogate_blend` alpha from 0.60 at RF threshold to 0.80 at 600+ pts so a mature surrogate has proportionally more influence over SALSA/GA candidate selection. §VVVVVVVVVVVV added 2026-08-29. §UUUUUUUUUUUU added 2026-08-28. §SSSSSSSSSSSS added 2026-08-25. §RRRRRRRRRRRR added 2026-08-24. §QQQQQQQQQQQQ (Morgan FP 64→256 bits) added 2026-08-23. §OOOO (SALSA bandit operator weighting) added 2026-08-22. §TTTTTTTTTTTT (reaction-class dead-end de-emphasis) added 2026-08-27. Item 5 remains as a conditional direction (binding-pocket docking filter, only relevant when `binding_pocket` is set in config). Items 70–71 proposed 2026-09-03: §ZZZZZZZZZZZZ (Boltz-2 binding-pose cache for structure-guided §MM growth vectors), §AAAAAAAAAAAA (GA population diversity injection from cross-epoch SQLite elite).
