...
def _init_boltz_cache_db(db_path: str) -> None:
    ...
    with sqlite3.connect(db_path) as conn:
        ...
        for _col_ddl in (
            ...
            # §UUUUUUUUUU: store Boltz-2 interface predicted distance error (Å, lower=better).
            # complex_ipde weights interface token-pairs by contact probability, directly
            # measuring binding-pose geometric uncertainty.  High ipde → uncertain interface
